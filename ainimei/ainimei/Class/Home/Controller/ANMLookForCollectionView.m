...
@interface ANMLookForCollectionView ()<UICollectionViewDelegate,UICollectionViewDataSource>
@property (nonatomic, weak)UICollectionView  *collectionView;
@property (nonatomic, strong) NSArray<ANMFreshModel*> *freshModelArr;
@end

@implementation ANMLookForCollectionView
...
-(NSArray<ANMFreshModel *> *)freshModelArr{
    if (_freshModelArr == nil) {
        ...
        [DSHTTPClient postUrlString:@"promotion.json.php" withParam:param withSuccessBlock:^(id data) {
